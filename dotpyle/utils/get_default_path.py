...
def get_default_path():
    """
    We need to know where to store information. If XDG_CONFIG_HOME is defined, it will use it.
    ...
    if default_config_path is not None:
        default_config_path = path.expanduser(
            "{0}/{1}".format(default_config_path, APP_NAME)
        )
